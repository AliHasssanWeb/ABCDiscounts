...
namespace ABC.POS.API.ViewModel
{
    public class EmailService
    {
        ...
        public bool SendNewOrderEmail(string type, string toEmail, List<CustomerOrder> order, List<CartDetail> cartdetail, List<PosSale> obj)
        {
            try
            {
                MailMessage mail = new MailMessage();
                ...
                //toEmail = "usmanamjad5529@outlook.com";
                //toEmail = "haseebshaukat12@gmail.com";
                mail.From = new MailAddress("eService@ab-sol.net");
                mail.To.Add(toEmail);
                if (type == "NewOrder")
                {
                    mail.Subject = "Order Confirmation";
                    mail.Body = ConfirmedNewOrder(toEmail, order[0].Email, order, cartdetail, obj);
                }
                mail.IsBodyHtml = true;
        ...
        private string ConfirmedNewOrder(string email, string fullname, List<CustomerOrder> orderlist, List<CartDetail> cartdetail, List<PosSale> obj)
        {
            ...
            html += "<br style='box-sizing:border-box'>";
            html += "<br style='box-sizing:border-box'>";
            html += "Thank you for placing an order with us! Please wait patiently as we prepare it. The Details of the order found below.";
            html += "</td>";
            html += "</tr>";
            html += "<tr style='box-sizing:border-box'>";
            ...
            html += "<tr style='box-sizing:border-box'>";
            html += "<td align='left' style='padding:0px 20px;font-size:18px;line-height:25px;font-family:Helvetica,Arial,sans-serif;color:rgb(80,80,80);box-sizing:border-box;min-width:5px;border:none'>";
            html += "Order Date:" + orderlist[0].OrderDate;
            html += "</td>";
            html += "</tr>";
            html += "<tr style='box-sizing:border-box'>";
            html += "<td align='left' style='padding:0px 20px;font-size:18px;line-height:25px;font-family:Helvetica,Arial,sans-serif;color:rgb(80,80,80);box-sizing:border-box;min-width:5px;border:none'>";
            html += "</br style='box-sizing:border-box'>Transaction ID:" + orderlist[0].TicketId;
            html += "</td>";
            html += "</tr>";
            html += "<tr style='box-sizing:border-box'>";
            html += "<td align='left' style='padding:0px 20px;font-size:18px;line-height:25px;font-family:Helvetica,Arial,sans-serif;color:rgb(80,80,80);box-sizing:border-box;min-width:5px;border:none'>";
            ...
            html += "" + orderlist.ElementAt(0).OrderDate.Value.Date.ToString("dd/MM/yyyy") + "";
            html += "</td>";
            ...
            for (int i = 0; i < orderlist.Count(); i++)
            {
                ...
                //html += "</td>";
                html += "<hr 'style=width:100%;border-top: 1px dashed black;'></td>";

              
                html += "</tr>";
                if (cartdetail[i].Quantity != int.Parse(obj[i].Quantity))
                {
                    //html += "<p style='font-size:12px'>Quantity of "+ obj[i].ItemName + " you order which is "+ cartdetail[i].Quantity + " is exeed from Online Limit. So we have sent you this item with the quantity of " + obj[i].Quantity+"</p>";
                    html += "<tr><td style='padding:0px 20px 5px;font-size:18px;line-height:25px;font-family:Helvetica,Arial,sans-serif;color:rgb(80,80,80);text-align:right;vertical-align:top;box-sizing:border-box;min-width:5px;border:0px solid rgb(221,221,221)' > ";
                    html += "<p style='font-size:12px'> Order Quantity was " + cartdetail[i].Quantity + "We Delivered you " + obj[i].RingerQuantity + "as per shipment policy"+ "</p>";
                    html += "</td></tr>";
                }
            }
            ...
            html += "</tr>";
            html += "<tr style='box-sizing:border-box'><td style='padding:0px 20px;font-size:12px;line-height:16px;font-family:Helvetica,Arial,sans-serif;color:rgb(80,80,80);box-sizing:border-box;min-width:5px;border:0px solid rgb(221,221,221)'>*Final delivery date will be determined after order approval " + orderlist[0].OrderDate + "</td></tr>";
            html += "</tbody>";
            html += "</table>";
            html += "</td>";
            html += "</tr>";
