...
namespace ABC.POS.Website.Controllers
{
    public class CustomerController : Controller
    {
        ...
        //                    large = Convert.ToInt32(record.Data[0].CustomerCode);
        //                    small = Convert.ToInt32(record.Data[0].CustomerCode);
        //                    for (int i = 0; i < record.Data.Count; i++)
        //                    {
        //                        if (record.Data[i].CustomerCode != null)
        //                        {
        //                            var t = Convert.ToInt32(record.Data[i].CustomerCode);
        //                            if (Convert.ToInt32(record.Data[i].CustomerCode) > large)
        //                            {
        //                                CustomerInfoID = Convert.ToInt32(record.Data[i].Id);
        //                                large = Convert.ToInt32(record.Data[i].CustomerCode);

        //                            }
        //                            else if (Convert.ToInt32(record.Data[i].CustomerCode) < small)
        //                            {
        //                                small = Convert.ToInt32(record.Data[i].CustomerCode);
        //                            }
        //                            else
        //                            {
        //                                if (large < 2)
        ...
        //        ////////////
        //        SResponse zipcode = RequestSender.Instance.CallAPI("api",
        //         "Customer/ZipCodeGet", "GET");
        //        if (zipcode.Status && (zipcode.Resp != null) && (zipcode.Resp != ""))
        //        {
        //            ResponseBack<List<ZipCode>> response =
        //                         JsonConvert.DeserializeObject<ResponseBack<List<ZipCode>>>(zipcode.Resp);
        //            if (response.Data.Count() > 0)
        //            {
        //                List<ZipCode> responseObject = response.Data;
        //                ViewBag.zipcode = new SelectList(responseObject.ToList(), "Id", "Code");
        //            }
        //            else
        //            {
        //                List<CustomerState> responseObject = new List<CustomerState>();
        //                ViewBag.CustomerState = new SelectList(responseObject.ToList(), "Id", "Code");
        //            }
        //        }
        //        else
        //        {
        ...
        //        SResponse Paymentterm = RequestSender.Instance.CallAPI("api",
        //        "Customer/PaymentTermGet", "GET");
        //        if (Paymentterm.Status && (Paymentterm.Resp != null) && (Paymentterm.Resp != ""))
        //        {
        //            ResponseBack<List<PaymentTerm>> response =
        //                         JsonConvert.DeserializeObject<ResponseBack<List<PaymentTerm>>>(Paymentterm.Resp);
        //            if (response.Data.Count() > 0)
        //            {
        //                List<PaymentTerm> responseObject = response.Data;
        //                ViewBag.PaymentTerm = new SelectList(responseObject.ToList(), "Id", "Name");
        //            }
        //            else
        //            {
        //                List<PaymentTerm> responseObject = new List<PaymentTerm>();
        //                ViewBag.PaymentTerm = new SelectList(responseObject.ToList(), "Id", "Name");
        //            }
        //        }
        //        else
        ...
        //            ViewBag.PaymentTerm = new SelectList(responseObject.ToList(), "Id", "Name");
        //        }
        //        SResponse Pricing = RequestSender.Instance.CallAPI("api",
        //        "Customer/PricingGet", "GET");
        //        if (Paymentterm.Status && (Paymentterm.Resp != null) && (Paymentterm.Resp != ""))
        //        {
        //            ResponseBack<List<Pricing>> response =
        //                         JsonConvert.DeserializeObject<ResponseBack<List<Pricing>>>(Pricing.Resp);
        //            if (response.Data.Count() > 0)
        //            {
        //                List<Pricing> responseObject = response.Data;
        //                ViewBag.Pricing = new SelectList(responseObject.ToList(), "Id", "Name");
        //            }
        //            else
        //            {
        //                List<Pricing> responseObject = new List<Pricing>();
        //                ViewBag.Pricing = new SelectList(responseObject.ToList(), "Id", "Name");
        //            }
        //        }
        //        else
        ...
        //}
        [HttpPost]
        public JsonResult NewCustomer(CustomerInformation customer)
        {
            try
            {
                ...
                {
                    HttpContext.Session.SetString("loadedCustomers", JsonConvert.SerializeObject(null));
                    TempData["response"] = "Account has been created.";
                    return Json("true");
                }
                else
                {
                    TempData["response"] = "Account creation failed.";
                    return Json("false");
                }
            }
            catch (Exception ex)
        ...
        public JsonResult EditCustomerInformation(CustomerInformation customer)
        {
            if (customer != null)
            {
                ...
                if (resp.Status && (resp.Resp != null) && (resp.Resp != ""))
                {
                    TempData["response"] = "Information Updated Successfully.";
                    return Json("true");
                }
                else
                {
                    TempData["response"] = "Failed to update";
                    return Json("false");
                }
            }
            return Json("false");
        ...
        public JsonResult AddShipToReference(ShiptoReference obj)
        {
            if (obj != null)
            {
                var body = JsonConvert.SerializeObject(obj);
                SResponse resp = RequestSender.Instance.CallAPI("api", "Customer/ShiptoReferenceCreate", "POST", body);
                if (resp.Status && (resp.Resp != null) && (resp.Resp != ""))
                {
                    return Json("true");
                }
        ...
        {
            string Msg = "";
            List<CustomerInformation> responseObject = new List<CustomerInformation>();
        ...
        public JsonResult SaleGetByCustomerID(int id)
        {
            SResponse ress = RequestSender.Instance.CallAPI("api",
               "Customer/SaleGetByCustomerID" + "/" + id, "GET");
            if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
            {
                var response = JsonConvert.DeserializeObject<ResponseBack<List<PosSale>>>(ress.Resp);
                if (response.Data != null)
                {
                    var responseObject = response.Data;
                    return Json(responseObject);
        ...
        public JsonResult PaymentsGetByCustomerID(int id)
        {
            SResponse ress = RequestSender.Instance.CallAPI("api",
               "Customer/GetPaymentsByCustomerID" + "/" + id, "GET");
            if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
            {
                var response = JsonConvert.DeserializeObject<ResponseBack<List<PosSale>>>(ress.Resp);
                if (response.Data != null)
        ...
        public JsonResult POSSaleGetByCustomerId(int customerid, string currentInvoice)
        {
            SResponse ress = RequestSender.Instance.CallAPI("api",
               "Customer/POSSaleGetByID" + "/" + customerid + "/" + currentInvoice, "GET");
            if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
            {
                var response = JsonConvert.DeserializeObject<ResponseBack<List<PosSale>>>(ress.Resp);
                if (response.Data != null)
                {
                    var responseObject = response.Data;
                    var records = JsonConvert.SerializeObject(responseObject);
                    TempData["saleorderInfoExisting"] = records;
                    for (int i = 0; i < responseObject.Count(); i++)
                    {
                        if (responseObject[i].ItemInDiscount == null)
                        {
                            responseObject[i].ItemInDiscount = "";
                        }
                        if (responseObject[i].ItemOutDiscount == null)
                        {
                            responseObject[i].ItemOutDiscount = "";
                        }
                        if (responseObject[i].InUnits == null)
                        {
                            responseObject[i].InUnits = "";
                        }
                        if (responseObject[i].OutDiscount == null)
                        {
                            responseObject[i].OutDiscount = "";
                        }
                        if (responseObject[i].OutUnits == null)
                        {
                            responseObject[i].OutUnits = "";
                        }
                        if (responseObject[i].ShippedName == null)
                        {
                            responseObject[i].ShippedName = "";
                        }
                        if (responseObject[i].DriverName == null)
                        {
                            responseObject[i].DriverName = "";
                        }
                        if (responseObject[i].PaymentTerms == null)
                        {
                            responseObject[i].PaymentTerms = "";
                        }
                    }
                    return Json(responseObject);
                }
        ...
        public IActionResult ExistingSaleInvoicePdf(InvoiceModel model)
        {
            try
            {
                var list1 = TempData["saleorderInfoExisting"];
                var list2 = JsonConvert.DeserializeObject<List<PosSale>>((string)list1);
                //var infolist = TempData["saleorderInfoExisting2"];
                ...
                for (int i = 0; i < list2.Count(); i++)
                {
                    ...
                    //var amount = (Convert.ToDouble(list2[i].RingerQuantity) * Convert.ToDouble(list2[i].Price));
        ...
        public JsonResult Addpricing(Pricing obj)
        {
            if (obj != null)
            {
                var body = JsonConvert.SerializeObject(obj);
                SResponse resp = RequestSender.Instance.CallAPI("api", "Customer/PricingCreate", "POST", body);
                if (resp.Status && (resp.Resp != null) && (resp.Resp != ""))
                {
                    return Json("true");
                }
        ...
        public JsonResult Addpaymentterms(PaymentTerm obj)
        {
            if (obj != null)
            {
                var body = JsonConvert.SerializeObject(obj);
                SResponse resp = RequestSender.Instance.CallAPI("api", "Customer/PaymentTermCreate", "POST", body);
                if (resp.Status && (resp.Resp != null) && (resp.Resp != ""))
                {
                    return Json("true");
                }
        ...
        public JsonResult AddZipCode(ZipCode obj)
        {
            if (obj != null)
            {
                var body = JsonConvert.SerializeObject(obj);
                SResponse resp = RequestSender.Instance.CallAPI("api", "Customer/ZipCodeCreate", "POST", body);
                if (resp.Status && (resp.Resp != null) && (resp.Resp != ""))
                {
                    return Json("true");
                }
        ...
        public JsonResult GetListZipCode()
        {
            SResponse zipcode = RequestSender.Instance.CallAPI("api",
            "Customer/ZipCodeGet", "GET");
            if (zipcode.Status && (zipcode.Resp != null) && (zipcode.Resp != ""))
        ...
        public JsonResult ZipCodeByID(int id)
        {
            SResponse ress = RequestSender.Instance.CallAPI("api",
               "Customer/ZipCodeByID" + "/" + id, "GET");
            if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
            {
                var response = JsonConvert.DeserializeObject<ResponseBack<ZipCode>>(ress.Resp);
                if (response.Data != null)
                {
                    var responseObject = response.Data;
                    return Json(responseObject);
        ...
        public JsonResult DeleteZipCode(int id)
        {
            SResponse ress = RequestSender.Instance.CallAPI("api",
               "Customer/DeleteZipCode" + "/" + id, "DELETE");
            if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
            {
                return Json(true);
            }
        ...
        public JsonResult ZipCodeUpdate(ZipCode zipCode)
        {
            var id = zipCode.Id;
            if (zipCode != null)
            {
                var body = JsonConvert.SerializeObject(zipCode);
                SResponse ress = RequestSender.Instance.CallAPI("api",
                   "Customer/ZipCodeUpdate" + "/" + id, "PUT", body);
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
                    return Json(true);
                }
        ...
        public JsonResult showstatelist()
        {
            StatesofAmerica obj = new StatesofAmerica();
            var statesofamericalist = obj.Get();
            if (statesofamericalist != null)
            {
                return Json(statesofamericalist);
            }
            else
            {
                return Json(false);
        ...
        public IActionResult OrdersForInvoice()
        {
            try
            {
                int userid = 0;
                ...
                SResponse ress = RequestSender.Instance.CallAPI("api", "Customer/AllCashierOrderGet/" + userid , "GET");
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
                    ...
                    if (response.Data.Count() > 0)
                    {
                        ...
                        var Record = response.Data.ToList().Where(x => x.IsPulled == true && x.AdminStatus == true && x.Delivered == false  && x.IsRejected == false && x.IsInvoiced == false).ToList();
        ...
        public IActionResult SaleHistory()
        {
            try
            {
                SResponse ress = RequestSender.Instance.CallAPI("api", "Inventory/GetSaleHistory", "GET");
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
                    ResponseBack<List<SaleHistory>> response =
                                 JsonConvert.DeserializeObject<ResponseBack<List<SaleHistory>>>(ress.Resp);
                    if (response.Data.Count() > 0)
                    {
                        //var Record = response.Data.ToList().Where(x => x.IsPulled == true && x.AdminStatus == true && x.Delivered == false && x.IsRejected == false && x.IsInvoiced == false).ToList();
                        var list = response.Data.ToList().GroupBy(x => x.TicketId).Select(i => i.FirstOrDefault()).ToList();
                        return View(list);
                    }
                    else
                    {
                        TempData["response"] = "No Sale History";
                    }
                }
        ...
        public IActionResult GetSaleHistorybyID(string ticketId)
        {
            try
            {
                SResponse resp = RequestSender.Instance.CallAPI("api", "Inventory/GetSaleHistotyById/" + ticketId, "GET");
                if (resp.Status && (resp.Resp != null) && (resp.Resp != ""))
                {
                    var response = JsonConvert.DeserializeObject<ResponseBack<List<SaleHistory>>>(resp.Resp);
                    return Json(response.Data);
                }
                return Json("null");
            }
        ...
        public IActionResult SaleApproval()
        {
            try
            {
                int userid = 0;
                ...
                SResponse ress = RequestSender.Instance.CallAPI("api", "Customer/AllCashierOrderGet", "GET");
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
                    ResponseBack<List<CustomerOrder>> response =
                                 JsonConvert.DeserializeObject<ResponseBack<List<CustomerOrder>>>(ress.Resp);
                    if (response.Data.Count() > 0)
                    {
                        ...
                        var Record = response.Data.ToList().Where(x => x.IsPulled == true && x.AdminStatus == true && x.Delivered == false && x.IsRejected == false && x.IsInvoiced == false && x.NeedApproval==true && x.AcceptApproval==false).ToList();
                        var list = Record.ToList().GroupBy(x => x.TicketId).Select(i => i.FirstOrDefault()).ToList();
                        return View(list);
                    }
                    else
        ...
        public IActionResult ApproveRequest(string ticketid)
        {
            try
            {
                int userid = 0;
                ...
                SResponse ress = RequestSender.Instance.CallAPI("api", "Customer/ApproveExceedRequest/"+ ticketid, "Get");
                {
                    var response = JsonConvert.DeserializeObject<ResponseBack<List<CustomerOrder>>>(ress.Resp);
                    return RedirectToAction("SaleApproval");
                }
        ...
        //public JsonResult CustomerTransByID(int id)
        //{
        //    SResponse ress = RequestSender.Instance.CallAPI("api",
        //       "Customer/CustomerTransactionByID" + "/" + id, "GET");
        //    if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
        //    {
        //        var response = JsonConvert.DeserializeObject<ResponseBack<List<Transaction>>>(ress.Resp);
        //        if (response.Data != null)
        //        {
        //            var responseObject = response.Data;
        //            return Json(responseObject);
        ...
        //public JsonResult CustomerStatsByID(int id)
        //{
        //    SResponse ress = RequestSender.Instance.CallAPI("api",
        //       "Customer/CustomerStatisticsByID" + "/" + id, "GET");
        //    if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
        //    {
        //        var response = JsonConvert.DeserializeObject<ResponseBack<AspNetUser>>(ress.Resp);
        //        if (response.Data != null)
        //        {
        //            ViewBag.lastsale = response.Data.lastsale;
        //            var responseObject = response.Data;
        //            return Json(responseObject);
        //        }
        //        else
        ...
        //public JsonResult CustomerAttachmentsByID(int id)
        //{
        //    SResponse ress = RequestSender.Instance.CallAPI("api",
        //       "Customer/GetCustomerAttachmentsByID" + "/" + id, "GET");
        //    if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
        //    {
        //        var response = JsonConvert.DeserializeObject<ResponseBack<AspNetUser>>(ress.Resp);
        //        if (response.Data != null)
        ...
        public IActionResult NewCustomer()
        {
            try
            {
                ...
                //  DOCUMENT TYPE GET
                SResponse ress = RequestSender.Instance.CallAPI("api",
                "Customer/SupplierDocumentTypeGet", "GET");
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
                        ...
                        if (record.Data[0].CustomerCode != null && record.Data[0].CustomerCode != "string" && record.Data[0].CustomerCode != "")
                        {
                            ...
                            for (int i = 0; i < record.Data.Count(); i++)
                            {
                                if (record.Data[i].CustomerCode != null)
                                {
                                    ...
                                    if (Convert.ToInt32(record.Data[i].CustomerCode) > large)
                                    {
                                        CustomerInfoID = record.Data[i].Id;
                                        large = Convert.ToInt32(record.Data[i].CustomerCode);
                            ...
                            newcustomer = record.Data.ToList().Where(x => x.Id == Convert.ToInt32(CustomerInfoID)).FirstOrDefault();
                            if (newcustomer != null)
                            {
                                if (newcustomer.CustomerCode != null)
                                {
        ...
        public JsonResult AddDocumentType(SupplierDocumentType obj)
        {
            try
            {
                var Msg = "";
                ...
                SResponse resp = RequestSender.Instance.CallAPI("api", "Customer/SupplierDocumentTypeCreate", "POST", body);
                if (resp.Status && (resp.Resp != null) && (resp.Resp != ""))
                {
                    TempData["response"] = "Documnet Type Added Successfully";
                    return Json(resp.Status);
                }
                else
                {
                    TempData["response"] = "Unable to add Document Type";
                    return Json(resp.Status);
                }
            }
            catch (Exception ex)
        ...
        //AddDocuments
        [HttpPost]
        public IActionResult AddCustomerDocument(CustomerDocument obj, IFormFile file)
        {
            try
            {
                var Msg = "";
                ...
                SResponse resp = RequestSender.Instance.CallAPI("api", "Customer/CustomerDocumentCreate", "POST", body);
                if (resp.Status && (resp.Resp != null) && (resp.Resp != ""))
                {
        ...
        public IActionResult CustomerDocumentsByCustomerId(int id)
        {
            try
            {

                SResponse ress = RequestSender.Instance.CallAPI("api",
               "Customer/CustomerDocumentGetByCustomerID" + "/" + id, "GET");
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
                    var response = JsonConvert.DeserializeObject<ResponseBack<List<SupplierDocument>>>(ress.Resp);
        ...
        public JsonResult DeleteCustomerDocument(int id)
        {
            SResponse ress = RequestSender.Instance.CallAPI("api",
               "Customer/CustomerDocumentDelete" + "/" + id, "Delete");
            if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
            {
                //TempData["response"] = "Delete Successfully!";
                return Json(ress.Status);
        ...
        public JsonResult GetNoteById(int noteId)
        {
            if (noteId != null)
            {

                SResponse resp = RequestSender.Instance.CallAPI("api", "Customer/GetNotesByID" + "/" + noteId, "GET");
                if (resp.Status && (resp.Resp != null) && (resp.Resp != ""))
                {
                    var response = JsonConvert.DeserializeObject<ResponseBack<CustomerNote>>(resp.Resp);
                    if (response.Data != null)
                    {
                        var responseObject = response.Data;
                        return Json(responseObject);
        ...
        public JsonResult AddCustomerNote(CustomerNote data)
        {
            if (data != null)
            {
                ...
                SResponse resp = RequestSender.Instance.CallAPI("api", "Customer/CustomerNoteCreate", "POST", body);
                if (resp.Status && (resp.Resp != null) && (resp.Resp != ""))
                {
                    return Json("true");
                }
        ...
        public JsonResult EditCustomerNotes(CustomerNote Note)
        {
            if (Note != null)
            {
                var id = Note.CustomerId;
                var body = JsonConvert.SerializeObject(Note);
                SResponse resp = RequestSender.Instance.CallAPI("api", "Customer/CustomerNotesUpdate" + "/" + id, "PUT", body);
                if (resp.Status && (resp.Resp != null) && (resp.Resp != ""))
                {
        ...
        //AddMultipleNotesAttachments
        [HttpPost]
        public IActionResult AddCustomerNotesMultipleDocument(CustomerDocument obj, IFormFile file)
        {
            try
            {
                var Msg = "";
                ...
                SResponse resp = RequestSender.Instance.CallAPI("api", "Customer/CustomerNotesMultipleDocumentCreate", "POST", body);
                if (resp.Status && (resp.Resp != null) && (resp.Resp != ""))
                {
                    Msg = "Add Successfully";
                    var jsonreturn = Json(resp.Status);
        ...
        //AddNotesAttachments
        [HttpPost]
        public IActionResult AddCustomerNotesDocument(CustomerDocument obj, IFormFile file)
        {
            try
            {
                var Msg = "";
                ...
                SResponse resp = RequestSender.Instance.CallAPI("api", "Customer/CustomerNotesDocumentCreate", "POST", body);
                if (resp.Status && (resp.Resp != null) && (resp.Resp != ""))
                {
                    Msg = "Add Successfully";
                    var jsonreturn = Json(resp.Status);
        ...
        public IActionResult NotesAttachmentByCustomerId(int id)
        {
            try
            {

                SResponse ress = RequestSender.Instance.CallAPI("api",
               "Customer/GetNotesAttachmentByCustomerId" + "/" + id, "GET");
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
                    var response = JsonConvert.DeserializeObject<ResponseBack<List<CustomerDocument>>>(ress.Resp);
                    if (response.Data != null && response.Data.Count() > 0)
                    {
                        var responseObject = response.Data;
                        return Json(responseObject);
        ...
        public JsonResult DeleteNoteAttachment(int id)
        {
            SResponse ress = RequestSender.Instance.CallAPI("api",
               "Customer/CustomerNotestDelete" + "/" + id, "Delete");
            if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
            {
                //TempData["response"] = "Delete Successfully!";
                return Json(ress.Status);
        ...
        public IActionResult GetCustomersCounter()
        {
            try
            {
                SResponse ress = RequestSender.Instance.CallAPI("api",
               "Customer/GetAllCustomersCounter" , "GET");
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
                    var response = JsonConvert.DeserializeObject<ResponseBack<int>>(ress.Resp);
                    if (response.Data != null)
                    {
                        var responseObject = response.Data;
                        return Json(responseObject);
        ...
        public IActionResult GetVendorsCounter()
        {
            try
            {
                SResponse ress = RequestSender.Instance.CallAPI("api",
               "Customer/GetAllVendorsCounter", "GET");
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
                    var response = JsonConvert.DeserializeObject<ResponseBack<int>>(ress.Resp);
                    if (response.Data != null)
        ...
        public IActionResult GetProductsCounter()
        {
            try
            {
                SResponse ress = RequestSender.Instance.CallAPI("api",
               "Inventory/GetAllProductsCounter", "GET");
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
                    var response = JsonConvert.DeserializeObject<ResponseBack<int>>(ress.Resp);
                    if (response.Data != null)
        ...
        public IActionResult GetTodaySalesCounter()
        {
            try
            {
                SResponse ress = RequestSender.Instance.CallAPI("api",
               "Purchase/GetTodayAllSalesCounter", "GET");
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
                    var response = JsonConvert.DeserializeObject<ResponseBack<int>>(ress.Resp);
                    if (response.Data != null)
        ...
        public IActionResult GetOnlineOrders()
        {
            ...
            {
                SResponse ress = RequestSender.Instance.CallAPI("api",
               "Purchase/GetAllOnlineOrders", "GET");
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
        ...
        public IActionResult GetCashierOrders()
        {
            try
            {
                string username = "";
                ...
                SResponse ress = RequestSender.Instance.CallAPI("api",
               "Purchase/GetCashierOrdersByName" + "/" + username, "GET");
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
                    var response = JsonConvert.DeserializeObject<ResponseBack<double>>(ress.Resp);
                    if (response.Data != null)
        ...
        public IActionResult GetLastActivity()
        {
            try
            {
                int id;
                ...
                SResponse ress = RequestSender.Instance.CallAPI("api",
               "Customer/GetLastActivityLog/" + id , "GET");
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
                    var response = JsonConvert.DeserializeObject<ResponseBack<ActivityLog>>(ress.Resp);
                    if (response.Data != null)
                    {
                        var responseObject = response.Data.NewDetails;
                        return Json(responseObject);
                    }
                    else
                    {
        ...
        public IActionResult GetReceiveables()
        {
            try
            {
                SResponse ress = RequestSender.Instance.CallAPI("api",
               "Inventory/GetAllReceivables", "GET");
                if (ress.Status && (ress.Resp != null) && (ress.Resp != ""))
                {
                    var response = JsonConvert.DeserializeObject<ResponseBack<double>>(ress.Resp);
                    if (response.Data != null)
