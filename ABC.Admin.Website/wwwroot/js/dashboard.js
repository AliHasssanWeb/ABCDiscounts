(function ($) {
    ...
    $(function () {
        ...
        if ($('#pendingdelivered').length) {
            var bar = new ProgressBar.Circle(pendingdelivered, {
                color: '#fff',
        ...
        if ($('#totaldelivered').length) {
            var bar = new ProgressBar.Circle(totaldelivered, {
                color: '#fff',
                // This has to be the same size as the maximum width to
                // prevent clipping
                strokeWidth: 15,
        ...
        if ($('#rejectedorders').length) {
            var bar = new ProgressBar.Circle(rejectedorders, {
                color: '#fff',
                // This has to be the same size as the maximum width to
                // prevent clipping
                strokeWidth: 15,
